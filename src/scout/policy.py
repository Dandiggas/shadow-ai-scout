...
def default_requirements() -> list[Requirement]:
    return [
        ...
        Requirement(id="soc2_iso", label="SOC2 or equivalent preferred", required=False, keywords=["soc 2", "soc2", "iso 27001", "iso27001"], fail_weight=8),
        Requirement(id="audit_logs", label="Audit logs preferred", required=False, keywords=["audit log", "audit logs", "logging"], fail_weight=8),
    ]
